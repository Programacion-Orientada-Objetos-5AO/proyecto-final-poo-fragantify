...
public class TareaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TareaResponseDTO> obtener(@PathVariable("id") Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TareaResponseDTO> actualizar(@PathVariable("id") Long id, @Valid @RequestBody TareaRequestDTO dto) {
    ...
    public ResponseEntity<TareaResponseDTO> completar(@PathVariable("id") Long id) {
        Tarea tarea = tareaService.marcarCompletada(id);
        return ResponseEntity.ok(tareaMapper.toDTO(tarea));
    }

    @GetMapping("/resumen/{creador}")
    public ResponseEntity<ResumenCreadorDTO> resumen(@PathVariable("creador") String creador) {
